...
//		QueryStats.moveToNext().update(moveToNextTimeInNanos, TimeUnit.NANOSECONDS);
  ...
  protected long aggregationTimeInNanos = 0;
  protected long interpolationTimeInNanos = 0;
  protected long downsampleTimeInNanos = 0;
  protected long moveToNextTimeInNanos = 0;
